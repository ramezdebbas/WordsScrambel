(function () {
    ...
    function generateSampleData() {
        var itemContent = "";
        var itemDescription = "Put your puzzle solving skills to the test with our adjective word scramble. Look carefully at the jumbled words and try unscrambling as many of the anagrams as you can into real adjectives (describing words).";
		...
		// var imagefirstlof = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXY5g8dcZ/AAY/AsAlWFQ+AAAAAElFTkSuQmCC";
        // Each of these sample groups must have a unique key to be displayed
        // separately.
        var sampleGroups = [
            { key: "group1", title: " Words Scramble Game ", subtitle: "english fun for kids", backgroundImage: "/images/frantpic.jpg", description: groupDescription }
        ...
        // group.
        var sampleItems = [
            { group: sampleGroups[0], title: "Adjacent words", subtitle: "daily routine words", description: itemDescription, content: itemContent, backgroundImage: "/images/abc1.jpg" },
            { group: sampleGroups[0], title: "Food Words", subtitle: "fruits & vegitables words", description: "This food word scramble will test your problem solving skills", content: itemContent, backgroundImage: "/images/food.png" },
            { group: sampleGroups[0], title: "Human Body", subtitle: "parts of human body words", description: "How many words can you unscramble in our human body word scramble?", content: itemContent, backgroundImage: "/images/hpart.jpg" },
            { group: sampleGroups[0], title: "Weather ", subtitle: "weather words", description: "Give this weather word scramble a go and see how many problems you can solve.", content: itemContent, backgroundImage: "/images/weathr.jpg" },
            { group: sampleGroups[0], title: "Animals", subtitle: "Word scramble", description:"Can you rearrange the letters to make the names of animals? Give it a go and find out!", content: itemContent, backgroundImage:"/images/animal.jpg" }
