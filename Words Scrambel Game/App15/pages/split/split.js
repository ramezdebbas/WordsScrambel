    ...
    ui.Pages.define("/pages/split/split.html", {
        ...
        _isSingleColumn: function () {
            ...
            if (this._itemSelectionIndex == 0) {
                ...
                document.getElementById("btnplaysapn").innerHTML = "";
                document.getElementById("txtsapn").innerHTML = "";
                document.getElementById("btspan").innerHTML = "";

                var btnplay = document.createElement("input");
                btnplay.setAttribute("type", "button");
                btnplay.setAttribute("id", "btnext");
                btnplay.setAttribute("value", "play");
                btnplay.setAttribute("onclick", "readpictureenglish()");
                // document.getElementById("btnext").value = "bilal";
                document.getElementById("btnplaysapn").appendChild(btnplay);


                var element = document.createElement("input");
                element.setAttribute("type", "button");
                element.setAttribute("value", "compare");

                element.setAttribute("onclick", "comareto()");

                var txtele = document.createElement("input");
                txtele.setAttribute("type", "text");
                txtele.setAttribute("id", "txtcheck");
                // txtele.setAttribute("value", "invert");

                // txtele.setAttribute("onclick", "readpicture()");

                var foo = document.getElementById("btspan");

                //Append the element in page (in span).
                foo.appendChild(element);

                // foo.appendChild(txtele);
                document.getElementById("txtsapn").appendChild(txtele);

                //  document.getElementById("btnext").value = "play";

            }//end of index0



            if (this._itemSelectionIndex == 1) {
                ...
                btnplay.setAttribute("id", "btnext");
                btnplay.setAttribute("value", "play");
                btnplay.setAttribute("onclick", "readpicturefood()");
                // document.getElementById("btnext").value = "bilal";
                document.getElementById("btnplaysapn").appendChild(btnplay);
            ...
            if (this._itemSelectionIndex == 2) {
                ...
                btnplay.setAttribute("id", "btnext");
                btnplay.setAttribute("value", "play");
                btnplay.setAttribute("onclick", "readpicturehbody()");
                // document.getElementById("btnext").value = "bilal";
                document.getElementById("btnplaysapn").appendChild(btnplay);
            ...
            if (this._itemSelectionIndex == 3) {
                ...
                btnplay.setAttribute("id", "btnext");
                btnplay.setAttribute("value", "play");
                btnplay.setAttribute("onclick", "readpictureweather()");
                // document.getElementById("btnext").value = "bilal";
                document.getElementById("btnplaysapn").appendChild(btnplay);
            ...
            if (this._itemSelectionIndex == 4) {
                ...
                btnplay.setAttribute("id", "btnext");
                btnplay.setAttribute("value", "play");
                btnplay.setAttribute("onclick", "readpictureanimal()");
                // document.getElementById("btnext").value = "bilal";
                document.getElementById("btnplaysapn").appendChild(btnplay);
